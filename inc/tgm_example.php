...
function bsv_eccommerce_register_required_plugins()
{
  $plugins = array(
    ...
    //   'name' => 'Wpglobus',
    //   'slug' => 'wpglobus',
    //   'source' => 'http://vps5.bludelego.com/plugins/wc_wpglobus.zip',
    //   'required' => true,
    //   'external_url' => 'http://vps5.bludelego.com/plugins/wc_wpglobus.zip'
    // ),
    // array(
    //   'name' => 'Wpglobus Plus',
    //   'slug' => 'wpglobus-plus',
    //   'source' => 'http://vps5.bludelego.com/plugins/wpglobus-plus-1.5.1.zip',
    //   'required' => true,
    //   'external_url' => 'http://vps5.bludelego.com/plugins/wpglobus-plus-1.5.1.zip'
    // ),
    // array(
    //   'name'             => 'Rank Math – SEO Plugin for WordPress',
    //   'slug'             => 'seo-by-rank-math',
    //   'source' => 'http://vps5.bludelego.com/plugins/seo-by-rank-math.zip',
    //   'required' => true,
    //   'external_url' => 'http://vps5.bludelego.com/plugins/seo-by-rank-math.zip'
    // ),
    // array(
    //     'name' => 'Wp Mail Smtp',
    //     'slug' => 'wp-mail-smtp',
